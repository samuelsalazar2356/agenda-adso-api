...
export default function FormularioContacto({
  ...
  // useEffect para cargar los datos del contacto en edición (si existe) - CLASE 11
  useEffect(() => {
  ...
  // Función manejadora del envío del formulario - CLASE 11
  ...
  // Texto dinámico del título y del botón según el modo - CLASE 11
  ...
  return (
    ...
    >
      ...
      <div className="pt-2 flex flex-col md:flex-row md:items-center gap-3">
        ...
        {/* Botón secundario: cancelar edición (solo en modo edición) - CLASE 11 */}
        {estaEnEdicion && (
          <button
            type="button"
